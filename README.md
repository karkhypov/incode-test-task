...
## [Live Demo](https://gilded-zabaione-1e2d7d.netlify.app/)

## Description

The app displays price ticker data on the UI in realtime. Price data is available from a locally running service (see information below). Code is covered with tests.
...
Tickers used by the application:
- **AAPL** - Apple
- **GOOGL** - Alphabet
- **MSFT** - Microsoft
- **AMZN** - Amazon
